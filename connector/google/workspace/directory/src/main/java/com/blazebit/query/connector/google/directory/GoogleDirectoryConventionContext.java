 ...
 * @since 1.0.0
 */
public class GoogleDirectoryConventionContext implements ConventionContext {

	public static final ConventionContext INSTANCE = new GoogleDirectoryConventionContext();

	private GoogleDirectoryConventionContext() {
	}

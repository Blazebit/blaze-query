 ...
 * @since 1.0.0
 */
public class GoogleWorkspaceEndpointVerificationConventionContext implements ConventionContext {

	public static final ConventionContext INSTANCE = new GoogleWorkspaceEndpointVerificationConventionContext();

	private GoogleWorkspaceEndpointVerificationConventionContext() {
	}

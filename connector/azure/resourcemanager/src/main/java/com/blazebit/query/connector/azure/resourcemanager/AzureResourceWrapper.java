 ...
 * @since 1.0.0
 */
public abstract class AzureResourceWrapper<T> {
	...
	public AzureResourceWrapper(String tenantId, String subscriptionId, String resourceGroupName, String resourceName, T payload) {
	...
	public AzureResourceWrapper(String tenantId, String resourceId, T payload) {
		this.tenantId = tenantId;

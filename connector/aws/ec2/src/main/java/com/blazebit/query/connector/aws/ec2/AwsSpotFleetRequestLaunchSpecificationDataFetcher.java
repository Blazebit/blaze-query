 ...
 * @since 1.0.0
 */
public class AwsSpotFleetRequestLaunchSpecificationDataFetcher implements DataFetcher<AwsSpotFleetRequestLaunchSpecification>, Serializable {

	public static final AwsSpotFleetRequestLaunchSpecificationDataFetcher INSTANCE = new AwsSpotFleetRequestLaunchSpecificationDataFetcher();

	private AwsSpotFleetRequestLaunchSpecificationDataFetcher() {
	}

	@Override
	public List<AwsSpotFleetRequestLaunchSpecification> fetch(DataFetchContext context) {
		try {
			List<AwsConnectorConfig.Account> accounts = AwsConnectorConfig.ACCOUNT.getAll( context );
			SdkHttpClient sdkHttpClient = AwsConnectorConfig.HTTP_CLIENT.find( context );
			List<AwsSpotFleetRequestLaunchSpecification> list = new ArrayList<>();
						...
						for ( SpotFleetRequestConfig spotFleetRequestConfig : client.describeSpotFleetRequests()
							...
							if ( spotFleetRequestConfig.spotFleetRequestConfig() != null
								...
								for ( SpotFleetLaunchSpecification launchSpecification : spotFleetRequestConfig.spotFleetRequestConfig().launchSpecifications() ) {
									list.add( new AwsSpotFleetRequestLaunchSpecification(
	...
	public DataFormat getDataFormat() {
		return DataFormats.componentMethodConvention( AwsSpotFleetRequestLaunchSpecification.class, AwsConventionContext.INSTANCE );
	}
}

 ...
 * @since 1.0.0
 */
public class AwsEbsEncryptionByDefault extends AwsWrapper<GetEbsEncryptionByDefaultResponse> {
	public AwsEbsEncryptionByDefault(String accountId, String regionId, String resourceId,

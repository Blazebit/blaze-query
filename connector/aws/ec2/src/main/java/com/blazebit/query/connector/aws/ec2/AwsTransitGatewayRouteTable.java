 ...
 * @since 1.0.0
 */
public class AwsTransitGatewayRouteTable extends AwsWrapper<TransitGatewayRouteTable> {
	public AwsTransitGatewayRouteTable(String accountId, String regionId, String resourceId,

 ...
 * @since 1.0.0
 */
public class AwsSnapshotAttribute extends AwsWrapper<DescribeSnapshotAttributeResponse> {
	public AwsSnapshotAttribute(String accountId, String regionId, String resourceId,

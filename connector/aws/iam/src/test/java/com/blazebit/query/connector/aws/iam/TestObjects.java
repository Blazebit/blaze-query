...
public final class TestObjects {
	...
	public static AwsUser userWithMfa() {
		User user = User.builder()
				...
				.build();
		return new AwsUser( "123", user.userId(), user );
	}

	public static AwsMFADevice mfaDevice() {
		MFADevice mfaDevice = MFADevice.builder()
				...
				.build();
		return new AwsMFADevice( "123", mfaDevice.serialNumber(), mfaDevice );
	}

	public static List<AwsPasswordPolicy> defaultAccountPasswordPolicy() {
		PasswordPolicy passwordPolicy = PasswordPolicy.builder()
				...
				.hardExpiry( false )
				.build();
		return Collections.singletonList( new AwsPasswordPolicy( "123", passwordPolicy ) );
	}
	...
	public static AccountSummary accountSummary() {
		var test =
				GetAccountSummaryResponse.builder()
						...
						.build();
		return new AccountSummary( "123", test.summaryMap() );
	}
}

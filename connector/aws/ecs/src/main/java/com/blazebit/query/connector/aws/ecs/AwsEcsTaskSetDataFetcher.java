 ...
 * @since 1.0.0
 */
public class AwsEcsTaskSetDataFetcher implements DataFetcher<AwsEcsTaskSet>, Serializable {

	public static final AwsEcsTaskSetDataFetcher INSTANCE = new AwsEcsTaskSetDataFetcher();

	private AwsEcsTaskSetDataFetcher() {
	}

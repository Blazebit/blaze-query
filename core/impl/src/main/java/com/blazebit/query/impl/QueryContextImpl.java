...
public class QueryContextImpl implements QueryContext {
    ...
    private static <T> ResultExtractor<T> getResultExtractor(ResultSet resultSet,
    ...
    public <T> Stream<T> getResultStream(TypedQueryImpl<T> query,
        PreparedStatement preparedStatement) {
        configurationProvider.setQuery(query);
        try {
            ResultSetIterator<T> iterator = new ResultSetIterator<>(query,
